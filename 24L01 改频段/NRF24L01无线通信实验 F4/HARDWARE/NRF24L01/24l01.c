...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x34,0x28,0x10,0x10,0x01}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x34,0x28,0x10,0x10,0x01}; //发送地址
...
void NRF24L01_RX_Mode(void)
{
  ...
  NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,28);	     //设置RF通信频率		  
...
{														 
  ...
  NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,28);       //设置RF通道为40
  NRF24L01_Write_Reg(NRF_WRITE_REG+RF_SETUP,0x0f);  //设置TX发射参数,0db增益,2Mbps,低噪声增益开启   
